...
for (const expected of [
  ...
  "BL-9TVJ-ph8",
  "YouTubeで見る",
  "/images/interactive/product-film-poster.jpg",
  "聞き逃しも、疑問も、",
  "その場で次の理解へ。",
...
for (const expected of [
  ...
  "/images/founder-portfolio/yuto-matsui-city-night-hero-centered-20260917-v2.webp",
  ...
  "/images/founder-portfolio/yuto-matsui-nagano-lake-hero-centered-20260917.webp",
  ...
  "/images/founder-portfolio/fragments/yuto-2360-anchor-1566.webp",
  "/images/founder-portfolio/fragments/code-data-1920.webp",
  "/images/founder-portfolio/fragments/yuto-2339-rain-1044.webp",
  "/images/founder-portfolio/fragments/yuto-yokohama-city-1600.webp",
  "/images/founder-portfolio/fragments/yuto-nagano-highland-1566.webp",
  "/images/founder-portfolio/fragments/silicon-wafer-1920.webp",
  "/images/founder-portfolio/fragments/yuto-704-1372.webp",
  'data-products-cinematic="true"',
  'data-scene="interactive"',
  'data-scene="library"',
...
// Chapters 02-04 are serialized as the client continuation slot and mount after expansion.
...
expectOrdered(founderStoryText, [
  "高校時代の2020年頃から趣味でプログラミングを始め、Webアプリケーション開発を中心に学びました。当時は現在のようなAIやコーディングエージェントはなく、実装、デバッグ、Git操作の多くを手作業で行う時代でした。開発そのものにも強く惹かれていましたが、科学によって生命の仕組みを解き明かし、新しい治療につなげることにも魅力を感じ、大学では薬学部へ進学しました。",
  ...
  "現在は、生命科学研究を継続しながら、教育・研究支援システムの開発、研究OSの構築、ITベンチャーでのエンジニアリングにも取り組んでいます。研究・教育現場の課題を理解し、それを要件へ落とし込み、実装可能なシステムへ変換することが、現在の私のエンジニアリングの中心です。",
  ...
  "実験研究では、不確実性の高い仮説検証に多くの時間と認知資源が必要です。一方、ソフトウェア開発では、AIによって価値創造のワークフローそのものが大きく変わりました。私はこの二つの現場を同時に経験してきたからこそ、その間にまだ大きな未開拓領域があると考えています。",
  ...
  "生成AIの普及は、IT業界の働き方そのものを変えました。しかし、テクノロジーの可能性が、社会のあらゆる場所に等しく届いたわけではありません。特に教育や生命科学など、複雑な意思決定と高度な専門性を必要とする分野では、技術の進歩を現実の仕組みへと変えていくことに、今なお大きな参入障壁があります。",
  "私が目指すのは、そのような不確実性の渦の中でも、批判や失敗を恐れず、より良い未来をつくるために前へ進み続けることです。テクノロジーとライフサイエンスの融合により、人々の生産性そのものを再設計し、これまで当然とされてきた社会の前提そのものを書き変えることです。",
  "テクノロジーのさらなる先へ、共に進みませんか。"
], "Founder fixed personal statement");

expectOrdered(founderStoryText, ["Origin", "COMPASS", "The interface", "Future"], "Founder story chapter order");
expectExcludes(founderStoryText, "Two long-term themes", "Founder legacy story chapter");
expectExcludes(founderStoryText, "From a tool to COMPASS", "Founder legacy story chapter");
...
for (const expected of [
  ...
  "学生：学校名・学部・学年／企業・団体：名称・役職／教職員・研究者：所属機関・役職をご記入ください。",
  "確認コードを受け取る",
  "メールアドレスを確認",
  "メールアドレス確認済み",
  "メッセージは代表が直接確認します。",
...
for (const relative of [
  ...
  "images/founder-portfolio/yuto-matsui-profile-hero.webp",
  "images/founder-portfolio/yuto-matsui-nagano-lake-hero-20260831.webp",
  "images/founder-portfolio/yuto-matsui-city-night-hero-centered-20260917.webp",
  "images/founder-portfolio/yuto-matsui-nagano-lake-hero-centered-20260917.webp",
  "images/founder-portfolio/yuto-matsui-city-night-hero-centered-20260917-v2.webp",
  "images/founder-portfolio/yuto-matsui-illuminated-steps-hero-20260901.jpg",
  "images/founder-portfolio/yuto-matsui-nagano-mountain-hero-20260901.webp",
  ...
  "images/founder-portfolio/fragments/yuto-698-atmosphere-1477.webp",
  "images/founder-portfolio/fragments/microscope-pawel-1108.webp",
  "images/founder-portfolio/fragments/microscope-pawel-640.webp",
  "images/founder-portfolio/fragments/yuto-2339-rain-1044.webp",
  "images/founder-portfolio/fragments/yuto-704-1372.webp",
  "images/founder-portfolio/fragments/yuto-706-1044.webp",
  "images/founder-portfolio/fragments/yuto-mist-lift-1477.webp",
  "images/founder-portfolio/fragments/dna-automation-1920.webp",
