...
expectOrdered(founderStoryText, [
  "高校時代の2020年頃から趣味でプログラミングを始め、Webフロントエンド開発を中心に学びました。当時は現在のようなLLMやコーディングエージェントはなく、実装、デバッグ、Git操作の多くを手作業で行う時代でした。開発そのものにも強く惹かれていましたが、科学によって生命の仕組みを解き明かし、新しい治療につなげることにも魅力を感じ、大学では薬学部へ進学しました。",
