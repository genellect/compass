...
const firstFiles=['manifest.json',manifest.nav,'concourse.glb','room-shell.glb','signs.glb','exhibits.glb','iss-horizon.webp','top.glb','arrival.webp'];
const delivery=[];
...
const gateFiles=['src/components/Explorer/ExplorerEntry.tsx','src/components/Explorer/policy.ts'];
let minified='';
...
const report={version:manifest.version,blender:manifest.blender,
  ...
  notes:['Entry size is separately transpiled/minified modules, excluding React and Next runtime; not a network trace.','First-scene count excludes production v3 resources and the separately loaded film and sound. The independent page also fetches its production HDR.','GPU figures and frame rates require runtime measurement; file size does not establish rendering performance.'],delivery};
