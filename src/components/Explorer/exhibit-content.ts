...
export const exhibits: Record<SectionId, { label: string; title: string; body: string; href: string; cta: string }> = {
  top: { label: 'COMPASS', title: 'Don’t Just Learn. Build What’s Next.', body: '学生のうちから、世の中に残る仕事をしよう。', href: '/#top', cta: 'COMPASS' },
  vision: { label: 'Vision', title: '学びを、意思決定の力へ。', body: 'COMPASSは、学生が学びを自らの選択と挑戦に変えられる、新しい教育体験を目指しています。', href: '/#vision', cta: 'Vision' },
  experience: { label: 'Experience', title: '次の1歩は、ここから始まる。', body: '学びの仕組みづくりから、ビジコンへの挑戦、AIエージェント開発、大学を越えた交流まで。学生の「やってみたい」を、仲間と形にします。', href: '/#experience', cta: 'COMPASS Experience' },
