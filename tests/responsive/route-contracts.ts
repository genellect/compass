...
export const routeContracts: RouteContract[] = [
  ...
  },
  {
    ...
    criticalSelectors: [
      ...
      "#use-cases h2",
      "#security h2",
      "#educator-operations h2",
      "#adoption h2",
      "#adoption a[href='/contact/']",
      "#developers h2",
      "#start h2",
      "#start a",
    ],
  ...
  {
    name: "founder-english",
    path: "/en/",
    h1Lines: { min: 1, max: 2 },
    requiredSelectors: ["#top", "#expertise", "#work", "#statement", "#experience", "#fragments", "#off-hours", "#contact"],
    criticalSelectors: [
      "h1#english-founder-title",
      "#expertise h2",
      "#expertise article",
      "#work h2",
      "#work article",
      "#statement h2",
      "#statement [aria-controls='english-statement-continuation']",
      "#experience h2",
      "#experience article",
      "#fragments h2",
